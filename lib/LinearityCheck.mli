...
val get_entry : state_tbl -> identifier -> (ty * loop_depth * var_state) option
...
val add_entry : state_tbl -> identifier -> ty -> loop_depth -> state_tbl
...
val tbl_to_list : state_tbl -> (identifier * ty * loop_depth * var_state) list
